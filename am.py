...
def main_select():
    ...
    if madman == '1':
        login()
    if madman == '2':
        os.system('xdg-open https://github.com/asgharmalik37')
        main()
    elif madman == '0':
        os.system('exit')
    else:
...
def login():
    ...
    print logo
    print ''
    print ('\x1b[0;94m[ Login Main Menu ]').center(50)
    print ''
    print '\x1b[1;94m[1]\x1b[1;91m > \x1b[1;97mlogin using token'
    print ''
    print '\x1b[1;94m[2]\x1b[1;91m > \x1b[1;97mlogin using password'
    print ''
